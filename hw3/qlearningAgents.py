...
class QLearningAgent(ReinforcementAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        newQ=newQ+self.alpha*(reward+(self.discount*self.getValue(nextState)))
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        for f in featureVector:
            QValue=QValue+self.weights[f]*featureVector[f]
    ...
    def update(self, state, action, nextState, reward):
        ...
        for f in featureVector:
            self.weights[f]+=correction*self.alpha*featureVector[f]
        # End your code
